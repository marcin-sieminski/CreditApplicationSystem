...
namespace CreditApplicationSystem.DataAccess.Migrations
{
    ...
    [Migration("20210608183651_InitialMigration")]
            ...
            modelBuilder.Entity("CreditApplicationSystem.DataAccess.Entities.CreditApplication", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = 1,
                            DateOfLastStatusChange = new DateTime(2021, 6, 8, 0, 0, 0, 0, DateTimeKind.Local),
                            DateOfSubmission = new DateTime(2021, 6, 8, 0, 0, 0, 0, DateTimeKind.Local),
                            EmployeeId = 1,
                            IsActive = true,
                            Notes = "",
                            ProductTypeId = 1
